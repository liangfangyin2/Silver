...
namespace Silver.ViewFace
{
    public class ViewFaceUtil
    {
        ...
        /// <param name="faceType">人脸类型</param>
        /// <returns></returns>
        public static (int,string , float, string) CompareFace([NotNull] string imagePath, [NotNull] string faceType)
        {
            using var faceImage = SKBitmap.Decode(imagePath).ToFaceImage();
            using FaceDetector faceDetector = new FaceDetector();
            using FaceAntiSpoofing faceAntiSpoofing = new FaceAntiSpoofing();
            ...
            using (FaceRecognizer faceRecognizer = new FaceRecognizer())
            {
                ...
                return (1, keysWithValue.MemberId, bestMatch.Similarity, "成功");
            }
        }
        ...
        /// <param name="faceType">人脸类型</param>
        /// <returns></returns>
        public static (int, string,float ,string) CompareFace([NotNull] System.Drawing.Bitmap faceImage, [NotNull] string faceType)
        {
            //检测人脸信息
            using FaceDetector faceDetector = new FaceDetector();
            using FaceAntiSpoofing faceAntiSpoofing = new FaceAntiSpoofing();
